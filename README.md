<img align="right" width="320" src="git_poster.jpg" alt="I started with Hello World. Now I'm wondering how the world works." />
...
- [ NovaOS](https://github.com/Nigam-Vaghani/NovaOs) = Terminal dev assistant you talk to in plain English. `nova "fix import"`, `nova "analyze project"` — it does it, with AI summaries and undo. ⭐ Python
...
- [ Codeforces CLI](https://github.com/Nigam-Vaghani/codeforces_cli) = CLI tool for competitive programmers. Fetch, submit, suffer — all from the terminal. ⭐ Python
...
[![Gmail](https://img.shields.io/badge/Gmail-nigamvaghani@gmail.com-D14836?logo=gmail&logoColor=white)](mailto:nigamvaghani@gmail.com)
